...
public class IRODSClientConfig {
	...
	@JsonProperty("default_resource")
	private String defResc_;
	@JsonProperty("ssl_negotiation_policy")
	private String sslNegPolicy_;
	@JsonProperty("connection_timeout_in_seconds")
	private int connTimeout_;
	@JsonProperty("connection_management")
	private ConnectionManagementConfig connMgmConfig_;
	@JsonProperty("proxy_admin_account")
	private IRODSProxyAdminAccountConfig proxyAdminAcctConfig_;

	// @formatter:off
	@JsonCreator
	public IRODSClientConfig(@JsonProperty("host") String _host, @JsonProperty("port") Integer _port,
			@JsonProperty("zone") String _zone, @JsonProperty("default_resource") String _defaultResource,
